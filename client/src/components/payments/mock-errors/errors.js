import sendEvent from "../../../services/pagerduty/sendEvent";
import PD_CONSTANTS from "../../../services/pagerduty/constants";
...
export const transactionTimeout = () => {
  ...
  let payload = {
    ...
    payload: {
      ...
      custom_details: {
        ...
        event_id: generateID(),
        JVM_ARGS:
          "-Xms128m -Xmx512m -XX:+UseGCLogFileRotation -XX:+HeapDumpOnOutOfMemoryError",
        tags: ["aws-eks-prod", "pd_az:us-west-2c", "production", "mariadb"],
      },
    },
    images: [
...
export const cloudWatchBill = () => {
  let payload = {
    ...
    payload: {
      summary:
        "Warning: Build 0.1.11-5-g0c85fbc delayed; estimated charges breached (+10 USD)",
